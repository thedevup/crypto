...
st.markdown("""
We retrieves cryptocurrency prices for the top 100 cryptocurrency from the **CoinMarketCap**!
""")
#---------------------------------#
# About
expander_bar = st.beta_expander("About")
expander_bar.markdown("""
* **Python libraries used in this project:** base64, pandas, streamlit, matplotlib, BeautifulSoup, requests, json, time
